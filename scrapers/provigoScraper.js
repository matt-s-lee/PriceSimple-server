...
const paginatedScraper = async (url) => {
  ...
  while (await page.$("button.primary-button.primary-button--load-more-button")) {
    // ----------------------------------------------------------
    ...
    try {
      ...
      await page.click("button.primary-button.primary-button--load-more-button");
...
paginatedScraper(
  "https://www.provigo.ca/food/fruits-vegetables/fresh-vegetables/c/28195"
